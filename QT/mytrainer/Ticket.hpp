...
public:
	...
	TicketInfo() { }
    TicketInfo(const string &trainNumber, const string &start, const string &end, const Date &date, const Time &time, const SeatType type, const double &price, const int count) :
...
public:
	...
	TicketsInfo() { }
    TicketsInfo(const string &trainNumber, const string &start, const string &end, const Date &date, const Time &time, const double _price[SEAT_TYPE_NUM], const int _count[SEAT_TYPE_NUM]) :
		trainNumber(trainNumber),
		start(start),
		end(end),
		date(date),
