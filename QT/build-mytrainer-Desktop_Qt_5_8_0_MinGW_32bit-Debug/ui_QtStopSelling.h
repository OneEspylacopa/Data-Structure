...
public:
    ...
    {
        QtStopSelling->setWindowTitle(QApplication::translate("QtStopSelling", "MainWindow", Q_NULLPTR));
        label_4->setText(QApplication::translate("QtStopSelling", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">\350\275\246\346\254\241:</span></p></body></html>", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("QtStopSelling", "\345\217\226\346\266\210", Q_NULLPTR));
        label->setText(QApplication::translate("QtStopSelling", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">\346\227\245\346\234\237:</span></p></body></html>", Q_NULLPTR));
        pushButton->setText(QApplication::translate("QtStopSelling", "\345\201\234\346\255\242\345\217\221\345\224\256", Q_NULLPTR));
    } // retranslateUi
